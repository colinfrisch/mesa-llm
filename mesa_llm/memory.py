...
class Memory:
    ...
    def __init__(self, 
                 ...
                 api_key : str = os.getenv("OPENAI_API_KEY") or None,
                 llm_model : str = "gpt-4o-mini" or None,
                 agent : Agent = None):
        """
    ...
    def update_long_term_memory(self):
        ...
        short_term_memory_dict = [self.convert_entry_to_dict(entry) for entry in self.short_term_memory]
        ...
        self.long_term_memory = self.llm.generate(self.short_term_memory, self.long_term_memory, prompt, system_prompt)
